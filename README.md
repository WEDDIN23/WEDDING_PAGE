...
# Documentation
I have written a 
[blog post describing all the features of this wedding website]) and how to
...
# Contribute
Firstly, a big thanks 🙏🏻 for the overwhelming response on [HackerNews](https://news.ycombinator.com/item?id=18556787) and [Reddit]; and to support my work, you can click on one of the links under the Sponsors section or the button below.
